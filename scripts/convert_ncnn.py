...
print("1. Loading...")
ckpt = torch.load("wdn_x4v3.pth", map_location="cpu", weights_only=False)
...
pnnx.export(model, "wdn_x4v3", inputs=dummy)
del model, dummy
gc.collect()

param = "wdn_x4v3.ncnn.param"
bindata = "wdn_x4v3.ncnn.bin"
for f in [param, bindata]:
    if os.path.exists(f):
